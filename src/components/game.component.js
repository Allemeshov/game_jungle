...
import card1 from '../assets/images/game/1.png'
import card2 from '../assets/images/game/2.png'
import card3 from '../assets/images/game/3.png'
import card4 from '../assets/images/game/4.png'
import card5 from '../assets/images/game/5.png'
import card6 from '../assets/images/game/6.png'
import card7 from '../assets/images/game/7.png'
import card8 from '../assets/images/game/8.png'
import card9 from '../assets/images/game/9.png'
import card10 from '../assets/images/game/10.png'
import card11 from '../assets/images/game/11.png'
import card12 from '../assets/images/game/12.png'
import card13 from '../assets/images/game/13.png'
import card14 from '../assets/images/game/14.png'
import card15 from '../assets/images/game/15.png'
import card16 from '../assets/images/game/16.png'
import card17 from '../assets/images/game/17.png'
import card18 from '../assets/images/game/18.png'
...
export class GameComponent extends Component {
    ...
    onInit() {
        this.$el
            .querySelector('.game__board').innerHTML = ''
        this.$el
            .querySelector('.game__board')
            .addEventListener('click', cardClickHandler.bind(this))
        this.$el
            .querySelector('.game__board')
            .addEventListener('touchstart click', cardClickHandler.bind(this))
        this.$el
...
async function cardClickHandler(e) {
    if (e.target.dataset.id && !this.isAnimationGoing && e.target.dataset.usefull === 'true') {
        this.sound.play()
        ...
        if (this.firstCardId && this.firstCardId === Number(e.target.dataset.id)) {
            ...
            this.startAnimation()
            if (
                this.cards.find(el => el.id === this.firstCardId).number === this.cards.find(el => el.id === this.secondCardId).number
            ) {
